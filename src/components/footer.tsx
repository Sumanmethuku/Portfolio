...
const socialLinks = [
  ...
  {
    name: "Email",
    url: "mailto:sumanmethuku01@gmail.com",
  ...
  return (
    <footer className="border-t bg-card">
      <div className="container max-w-5xl mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            >
              ...
              <span className="font-semibold text-lg">Suman Methuku</span>
            </motion.div>
            <motion.p
            ...
            >
              Full Stack Web Developer building modern apps using React, Next.js and
              TypeScript. Based in Hyderabad, India.
            </motion.p>
          </div>
        ...
        >
          <p>© {currentYear} Suman Methuku. All rights reserved.</p>
          <p className="mt-1">
