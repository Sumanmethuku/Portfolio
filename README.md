...
* **Frontend:** React, Next.js, Tailwind CSS, JavaScript/TypeScript, Framer Motion
* **Backend:** Node.js, Express, Socket.io
* **Databases:** PostgreSQL, MySQL, SQL
* **Deployment:** Vercel, Heroku
* **Tools:** Git, Docker, VS Code, Cursor IDE
...
1.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Sumanmethuku/Portfolio.git
    ```
...
* **[LinkedIn](https://www.linkedin.com/in/suman-methuku/)**
* **[GitHub](https://github.com/Sumanmethuku)**
* **[Email](sumanmethuku01@gmail.com)**
